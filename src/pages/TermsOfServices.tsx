...
const TermsOfServicesPage: React.FC = () => {
  ...
  return (
    <Paper className={classes.root} square variant="outlined">
      <SEO title={`${COMPANY_NAME} - Terms of Services`} />
      ...
      <Container className={classes.container} maxWidth="lg">
        ...
        <Typography className={classes.paragraph}>
          This website is operated by Stcker.com. Throughout the site, the terms
          “we”, “us” and “our” refer to Stcker.com. Stcker.com offers this
        ...
        <Typography className={classes.subTitle} variant="h6">
          3. PRODUCTS OR SERVICES (if applicable)
        </Typography>
        <Typography className={classes.paragraph}>
        ...
        <Typography className={classes.paragraph}>
          ...
          can complete your transactions and contact you as needed. For more
        ...
        <Typography className={classes.paragraph}>
          In no case shall Stcker.com, our directors, officers, employees,
        ...
        <Typography className={classes.paragraph}>
          ...
          laws of Townsville, QLD, 4810, Australia.
        </Typography>
        <Typography className={classes.subTitle} variant="h6">
          14. INDEMNIFICATION
        </Typography>
        <Typography className={classes.paragraph}>
          You agree to indemnify, defend and hold harmless Stcker.com and our
        ...
        <Typography className={classes.subTitle} variant="h6">
          17. MODIFICATIONS TO THE SERVICE AND PRICES
        </Typography>
        <Typography className={classes.paragraph}>
